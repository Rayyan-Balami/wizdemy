...
rel="stylesheet">
  ...
  <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
    <div class="bg-gray-600 aspect-[21/9] flex flex-col">
      <div class="p-6 flex gap-4">
        <div class="rounded-md bg-red-600 p-4 aspect-square gid place-content-center">
        ...
        <div>
          <p class="truncate text-sm font-medium text-gray-300">Total Subscribers</p>
          <p class="text-2xl font-semibold text-gray-100">71,897</p>
        </div>
      </div>
      <a href="#" class="mt-auto flex items-center justify-between gap-4 px-6 py-4 bg-gray-500 ">
       View details for Total Subscribers <svg class="w-6 h-6 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" fill-rule="evenodd" d="M9.399 4.328a.75.75 0 0 1 1.06 0l6.364 6.363a1.75 1.75 0 0 1 0 2.475L10.46 19.53a.75.75 0 0 1-1.06-1.06l6.364-6.364a.25.25 0 0 0 0-.354L9.399 5.388a.75.75 0 0 1 0-1.06" clip-rule="evenodd"/></svg>
      </a>
    </div>
    <div class="bg-gray-600 aspect-[21/9] flex flex-col">
      <div class="p-6 flex gap-4">
