          ...
          <td class="actions-cell">
            <div>
              ...
              <button title="Suspend"
               class="suspend-btn  <?= $admin['status'] == 'suspend' ? 'active' : '' ?>"
              ...
              <!-- edit button  -->
              <a title="Edit"
               href="/admin/edit/admin/<?= $admin['admin_id'] ?>" class="edit-btn">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              ...
              <!-- delete button  -->
              <button title="Delete"
               class="delete-btn" onclick="deleteData('admin',<?= $admin['admin_id'] ?>, this)">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
