...
<div class="table-menus">
  <form action="#" method="GET">
    <div class="search-field">
      <input type="text" name="email" id="table-search-input" placeholder="Search ' REPORTS '&nbsp;&nbsp;&#x2044;&nbsp;&nbsp;or&nbsp;&nbsp;🄲🅃🅁🄻 +  🄺" class="search-input">
    </div>
  </form>
