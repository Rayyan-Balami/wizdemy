...
<div class="title-label">
    ...
    <p class="message">
    Correct yor mistakes and update your request.
    </p>
...
<div class="form-section">
    ...
    <!-- form -->
    <form action="/request/update/<?= $requestDetails['request_id'] ?>" id="requestForm" method="post">
    <input type="hidden" name="_method" value="PUT">
        ...
        <div class="title">
            ...
            <input type="text" placeholder="Need Lab Report of BCA" required name="title" id="title"
                value="<?= $flashOld['title'] ?? $requestDetails['title'] ?>">
        </div>
        ...
        <div class="description">
            ...
            <textarea required id="description" name="description"
                rows="3"><?= $flashOld['description'] ?? $requestDetails['description'] ?></textarea>
    ...
    <div class="educationLevel">
      ...
      <select name="educationLevel" id="educationLevel" required>
        ...
        foreach ($educationLevels as $label => $value) {
          $selected = (isset($flashOld['education_level']) && $flashOld['education_level'] === $value) || (isset($requestDetails['education_level']) && $requestDetails['education_level'] === $value) ? 'selected' : '';
          echo "<option value=\"$value\" $selected>$label</option>";
        }
        ?>
      </select>
    ...
    <div class="semester">
      ...
      <svg class="caret-up-down" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="subject">
            ...
            <input type="text" placeholder="C Programming" required name="subject" id="subject" value="<?= $flashOld['subject'] ?? $requestDetails['subject'] ?>" />
        </div>
        ...
        <div class="class">
            ...
            <input type="classFaculty" placeholder="Short ie 10 class, Management, Science, BCA, CSIT etc" required name="classFaculty"
                id="classFaculty" value="<?= $flashOld['class_faculty'] ?? $requestDetails['class_faculty'] ?>" />
        </div>
