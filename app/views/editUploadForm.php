<?php View::renderPartial('Header', [
  'pageTitle' => SITE_NAME . ' | Edit Materials',
  'stylesheets' => [
    'settingForm'
  ],
  'scripts' => [
...
<div class="title-label">
  ...
  <p class="message">
    Correct yor mistakes and update your study materials.
  </p>
</div>
  ...
  <form action="/material/update/<?= $materialDetails['material_id'] ?>" id="uploadForm" method="post"
    ...
    <div class="title">
      ...
      <input type="text" placeholder="functions in C programming language." required name="title" id="title"
        value="<?= $flashOld['title'] ?? $materialDetails['title'] ?>">
    </div>
    ...
    <div class="document-type">
      ...
      <select name="document-type" id="document-type" required>
        ...
        foreach ($documentTypes as $label => $value) {
          $selected = (isset($flashOld['document_type']) && $flashOld['document_type'] === $value) || (isset($materialDetails['document_type']) && $materialDetails['document_type'] === $value) ? 'selected' : '';
    ...
    <div class="format">
      ...
      <select name="format" id="format" required>
        ...
        foreach ($format as $label => $value) {
          $selected = (isset($flashOld['format']) && $flashOld['format'] === $value) || (isset($materialDetails['format']) && $materialDetails['format'] === $value) ? 'selected' : '';
          echo "<option value=\"$value\" $selected>$label</option>";
        }
        ?>
      </select>
    ...
    <div class="educationLevel">
      ...
      <select name="educationLevel" id="educationLevel" required>
        ...
        foreach ($educationLevels as $label => $value) {
          $selected = (isset($flashOld['education_level']) && $flashOld['education_level'] === $value) || (isset($materialDetails['education_level']) && $materialDetails['education_level'] === $value) ? 'selected' : '';
          echo "<option value=\"$value\" $selected>$label</option>";
        }
        ?>
      </select>
    ...
    <div class="semester">
      ...
      <select name="semester" id="semester">
        ...
        foreach ($semesters as $semester) {
          $selected = (isset($flashOld['semester']) && $flashOld['semester'] === $semester) || (isset($materialDetails['semester']) && $materialDetails['semester'] === $semester) ? 'selected' : '';
    ...
    <div class="subject">
      ...
      <input type="text" placeholder="C Programming" required name="subject" id="subject"
        value="<?= $flashOld['subject'] ?? $materialDetails['subject'] ?>" />
    </div>
    ...
    <div class="class">
      ...
      <input type="text" placeholder="Short ie 10 class, Management, Science, BCA, CSIT etc" required
        ...
        value="<?= $flashOld['class_faculty'] ?? $materialDetails['class_faculty'] ?>" />
    ...
    <div class="author">
      ...
      <input type="text" placeholder="Rayyan Balami" required name="author" id="author"
        value="<?= $flashOld['author'] ?? $materialDetails['author'] ?>" />
    </div>
    ...
    <div class="file-preview" id="image-file-preview">
      ...
      <div class="file-info" style="display: <?= isset($materialDetails['thumbnail_path']) ? 'block' : 'none' ?>">
        <p class="file-size"></p>
    ...
    <div class="file-preview" id="document-file-preview">
      ...
      <div class="file-info" style="display: <?= isset($materialDetails['file_path']) ? 'block' : 'none' ?>">
        <p class="file-size"></p>
