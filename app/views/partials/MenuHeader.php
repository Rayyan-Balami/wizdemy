  ...
  <header>
    <h1 class="logo">
      <a href="/">
        ...
        <!-- <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 36 36">
          ...
          <path fill="currentColor" d="M14.55 15.23v1.2h3v1.16h-3v1.32h3.33v1.16h-4.62v-6h4.62v1.16Z"
            class="clr-i-outline clr-i-outline-path-2" />
          <path fill="currentColor" d="M20.41 15.23h-1.87v-1.16h5v1.16H21.7v4.84h-1.29Z"
            class="clr-i-outline clr-i-outline-path-3" />
          <path fill="currentColor"
            d="M28 19.12h-2.68l-.38.95H23.5l2.44-6h1.44l2.45 6h-1.45ZM27.55 18l-.89-2.19l-.89 2.19Z"
            class="clr-i-outline clr-i-outline-path-4" />
          <path fill="currentColor"
            d="M8.06 30a.84.84 0 0 1-.38-.08a1 1 0 0 1-.62-.92v-4h-4a1 1 0 0 1-1-1V10a1 1 0 0 1 1-1h30a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H13.48l-4.71 4.71a1 1 0 0 1-.71.29m-4-7h4a1 1 0 0 1 1 1v2.59l3.3-3.3a1 1 0 0 1 .7-.29h19V11h-28Z"
    ...
    <div class="header-menu">
      ...
      <div class="h-links-wrapper">
        <!-- upload link -->
        <a href="/material/create" aria-label="upload study material link"
          class="h-link  <?= isset($currentPage) && $currentPage === 'uploadForm' ? 'active-header-menu' : ''; ?>">
        ...
        <!-- request link -->
        <a href="/request/create" aria-label="request study material link"
          class="h-link  <?= isset($currentPage) && $currentPage === 'requestForm' ? 'active-header-menu' : ''; ?>">
          <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
            <g id="SVGRepo_iconCarrier">
        ...
        <!-- add project link -->
        <a href="/project/create" aria-label="upload github project link"
          class="h-link <?= isset($currentPage) && $currentPage === 'projectForm' ? 'active-header-menu' : ''; ?>">
