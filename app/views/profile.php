    ...
    <div class="userstats-bio-wrapper">
      ...
      <div class="user-buttons">
        <?php if (!$myProfile && !$isCurrentUserFollower): ?>
            <button class="follow-button" onclick="followUser(<?= $user['user_id'] ?>)" id="follow-button">
        ...
        <?php elseif (!$myProfile && $isCurrentUserFollower): ?>
            <button class="follow-button" onclick="unfollowUser(<?= $user['user_id'] ?>)" id="unfollow-button">
