<div id="side-nav">
        ...
        <nav>
            ...
            <div class="menu-section">
                ...
                <ul>
                    <li>
                        <a href="index.html" class="menu-links  is-active">
                    ...
                    <li>
                        <a href="question.html" class="menu-links">
                    ...
                    <li>
                        <a href="labReport.html" class="menu-links">
                            <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                    ...
                    <li>
                        <a href="request.html" class="menu-links">
                            <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
            ...
            <div class="menu-section">
                ...
                <ul>
                    <li>
                        <a href="signupForm.html" class="signup-button">
                            Sign Up
                            <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    ...
                    <li>
                        <a href="loginForm.html" class="login-button">
                            Log In
                            <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
