...
<div id="searchOverlay" onclick="toggleSearchOverlay()">
    ...
    <div id="searchModal">
        <form class="search-form" id="search-bar" action="">
            <div id="back-button" onclick="closeSearchOverlay()">
        ...
        <ul>
            <li>
                ...
                <p>JavaScript and its application bca</p>
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
                        <path d="M17 17L7 7M7 7V16M7 7H16" stroke="currentColor" stroke-width="1.3"
