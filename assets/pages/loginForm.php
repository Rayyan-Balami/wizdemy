...
<main class="form">
    ...
    <!-- random image -->
    <div class="image">
        <img src="https://plus.unsplash.com/premium_photo-1682095643806-79da986ccf8d?q=80&w=2942&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt="" />
    </div>
        ...
        <div>
            ...
            <form method="post" action="assets/php/actions.php?login">
                ...
                <div class="email">
                    ...
                    <input type="text" placeholder="WizDemy@gmail.com" required name="email" id="email"value="<?php echo $_SESSION['old']['email'] ?? '' ?>" />
                </div>
                <!-- password -->
                <div class="password">
            ...
            <div class="share-message ">
                ...
                <div class="social-icons">
                    ...
                    <!-- messenger -->
                    <a href="#">
                        <svg viewBox="48.61 50.201 402.77399999999994 402.77399999999994"
...
<?php req_once('assets/components/Footer.php') ?>