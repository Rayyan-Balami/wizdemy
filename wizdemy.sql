...
--
-- Host: localhost
-- Generation Time: Apr 01, 2024 at 03:57 PM
...
--
ALTER TABLE `follow_relation`
  MODIFY `follow_relationship_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `study_materials`
  MODIFY `material_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `admin_action_log`
  ADD CONSTRAINT `admin_action_log_ibfk_1` FOREIGN KEY (`admin_id`) REFERENCES `admins` (`admin_id`);
